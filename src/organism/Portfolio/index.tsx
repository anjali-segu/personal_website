    ...
    <React.Fragment>
      ...
      <Panel backgroundColor={charcoal}>
        <Typography className={classes.title} variant={'h4'}>
          {'Coding and Art are my ultimate passions.'}
        </Typography>
        <Grid container>
          <Grid item md={2}/>
          <Grid item md={8}>
          <Typography className={classes.subtitle} variant={'h6'}>
            {`Art runs deep in my family and has become an integral part of
              my life. I quickly realized how similar coding is to art. It's
